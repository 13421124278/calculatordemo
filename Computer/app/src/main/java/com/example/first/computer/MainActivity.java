package com.example.first.computer;
...
public class MainActivity extends Activity implements OnClickListener {
        ...
        switch (v.getId()) {
            ...
            case R.id.bt_minus:
                if(editText1.getText().toString()==null||editText1.getText().toString().equals("")){
                    ...
                    if (!minus_flag) // 防止用户多次输入一个符号键，符号键只允许输入一次
                    {
                        result_flag = false;
                        value_list.add(Double.parseDouble(editText1.getText()
                                .toString()));// 将当前已输入的数字放入value_list
            ...
            case R.id.bt_multi:
                if(editText1.getText().toString()==null||editText1.getText().toString().equals("")){
                    ...
                    if (!multi_flag) // 防止用户多次输入一个符号键，符号键只允许输入一次
                    {
                        result_flag = false;
                        value_list.add(Double.parseDouble(editText1.getText()
                                .toString()));// 将当前已输入的数字放入value_list
            ...
            case R.id.bt_div:
                if(editText1.getText().toString()==null||editText1.getText().toString().equals("")){
                    ...
                    if (!div_flag) // 防止用户多次输入一个符号键，符号键只允许输入一次
                    {
                        result_flag = false;
                        value_list.add(Double.parseDouble(editText1.getText()
                                .toString()));// 将当前已输入的数字放入value_list
            ...
            case R.id.bt_backspace:
                ...
                if(editText1.getText().toString()==null||editText1.getText().toString().equals("")){
                    ...
                    editText1.setText(editText1.getText().toString().substring(0,
                            editText1.getText().toString().length()-1));
                    textView1.setText(textView1.getText().toString().substring(0,
                            textView1.getText().toString().length()-1));
    ...
    // 数字键按下，含0与.，类似000001223这类情况这里允许，因为java可以将000001223自己转化为1223
